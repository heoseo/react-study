...
export const reducerUtils = {
  //초기상태. 초기data값은 기본적으로 null이지만 바꿀 수 있음.
...
export const createPromiseTHunkById = (
  ...
  // idSelector를 param => param.id 이런 식으로 설정할 수 있음.
  ...
  return (param) => async (dispatch) => {
    ...
    try {
      ...
      dispatch({ type: ERROR, error: true, palyload: e, meta: id });
    }
  };
};
        ...
        return {
          ...
          [key]: {
            ...
            [id]: reducerUtils.loading(
              // state[key][id]가 만들어져 있찌 않을 수도 있으니까 유효성은 검사 후 data조회
